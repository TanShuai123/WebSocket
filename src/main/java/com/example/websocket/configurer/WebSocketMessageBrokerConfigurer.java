package com.example.websocket.configurer;

import com.example.websocket.Interceptor.MyChannelInterceptorAdapter;
import com.example.websocket.Interceptor.MyHandShakeInterceptor;
...
public class WebSocketMessageBrokerConfigurer extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        //registration.setInterceptors(myChannelInterceptorAdapter);
